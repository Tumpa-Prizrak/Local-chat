...
def error(msg: str):
    _log(level=ColoredText(text="[ERROR]", color=c.Fore.RED), msg=ColoredText(text=msg))
...
def info(msg: str):
    _log(level=ColoredText(text="[INFO]", color=c.Fore.BLUE), msg=ColoredText(text=msg))


def log(msg: str):
    _log(level=ColoredText(text="[LOG]", color=c.Fore.WHITE), msg=ColoredText(text=msg))
